                ...
                <div class="row align-items-center row-md-reverse">
                    ...
                    <div class="col-lg-7">
                        <div class="contact__form">
                            <form action="{{route('user.contact.submit')}}"  method="POST" id="contactmessage" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="contact__form--list mb-20">
                                            ...
                                            <input class="contact__form--input" name="number" placeholder="Phone number" type="number">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6">
                                        <div class="contact__form--list mb-20">
                                            <label class="contact__form--label" for="input4">Email <span class="contact__form--label__star">*</span></label>
                                            <input class="contact__form--input" name="email" placeholder="Email" type="email">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="contact__form--list mb-10">
                                            ...
                                            <textarea class="contact__form--textarea" name="message" placeholder="Write Your Message"></textarea>
                                        </div>
                                    </div>
                                </div>
