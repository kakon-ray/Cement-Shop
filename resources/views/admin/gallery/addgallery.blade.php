                            ...
                            <div class="card m-0 p-4">
                                <form method="POST" action="{{ route('admin.dashboard.product.add.submit') }}"
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Thumbnail Image<span class="text-danger">*</span> </label><br>
                                        ...
                                        <div class="my-4">
                                            ...
                                            <div class="my-4" id="dynamic_field">
                                                <input type="file" accept="image/*" name="images[1]" class="form-control my-4" />
                                            </div>
...
<script type="text/javascript">
    ...
    $("input[data-bootstrap-switch]").each(function(){
      ...
      $(document).ready(function(){      
         ...
         $('#add').click(function(){  
              i++;  
              $('#dynamic_field').append('<tr id="row'+i+'" class="dynamic-added"><td><input type="file" accept="image/*" name="images['+i+']" class="form-control name_list" /></td><td><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove">X</button></td></tr>');  
         });  
