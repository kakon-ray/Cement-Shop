            ...
            <div class="container">
                <div class="main__header--inner d-flex justify-content-between align-items-center">
                    ...
                    <div class="main__logo">
                        <h1 class="main__logo--title"><a class="main__logo--link" href="{{route('home')}}"><img class="main__logo--img" src="{{asset('user/img/logo/nav-logo.jpg')}}" alt="logo-img"></a></h1>
        ...
        <div class="offcanvas__stikcy--toolbar" tabindex="-1">
            <ul class="d-flex justify-content-between">
                <li class="offcanvas__stikcy--toolbar__list">
                    <a class="offcanvas__stikcy--toolbar__btn {{ request()->routeIs('home') ? 'active-nav-menue' : '' }}" href="{{route('home')}}">
