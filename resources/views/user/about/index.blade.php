...
@section('content')
                    ...
                    <div class="col">
                        <div class="breadcrumb__content">
                            ...
                            <ul class="breadcrumb__content--menu d-flex">
                                ...
                                <li class="breadcrumb__content--menu__items"><span class="text__secondary">About Us</span>
                                </li>
                            </ul>
                        </div>
                    </div>
	...
	<!-- End image with text section -->
        ...
        <div class="banner__video--section banner__section--bg position__relative section--padding">
            <img class="drone__position--img display-block" src="{{asset('user/img/other/drone-position-img.webp')}}"
            ...
            <div class="container">
                <div class="banner__video--content position__relative text-center">
                    <div class="bideo__play banner__video--play mb-35">
                        <a class="bideo__play--icon banner__video--play__icon glightbox" href="https://vimeo.com/115041822"
                            data-gallery="video">
                    ...
                    <p class="banner__video--info text-white">Get Your Quote or Call: <a
                            href="tel:+88021544142">(+88021544142)</a></p>
                        ...
                        <div class="about__content">
                            ...
                            <div class="about__content--author d-flex align-items-center mb-50">
                                ...
                                <div class="about__content--author__text d-flex align-items-center">
                                    ...
                                    <img class="about__author--signature display-block" src="{{asset('user/img/icon/signature.webp')}}"
                                        alt="signature">
                                </div>
                            </div>
                    ...
                    <div class="col">
                        <div class="newsletter__subscribe">
                            <form class="newsletter__subscribe position__relative" action="#">
                                <label>
                                    <input class="newsletter__subscribe--input style2" placeholder="Enter Your Email"
                                        type="email">
                                </label>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <article class="testimonial__card text-center">
                                <div class="testimonial__card--thumbnail">
                                    <img class="testimonial__card--thumbnail__img display-block"
                                        src="{{asset('user/img/other/testimonial1.webp')}}" alt="testimonial-img">
                                </div>
                                <div class="testimonial__content">
                                    <p class="testimonial__content--desc">Lorem ipsum dolor sit amet,elit, sed do eiusmod
                                ...
                                <div class="testimonial__icon">
                                    <svg class="testimonial__icon--svg" data-name="Group 546"
                                        xmlns="http://www.w3.org/2000/svg" width="18.479" height="13.939"
                                        ...
                                        <path data-name="Path 131"
                                            ...
                                            transform="translate(0 -7.328)" fill="currentColor"></path>
                                        <path data-name="Path 132"
                                            ...
                                            transform="translate(-58.45 -7.411)" fill="currentColor"></path>
                                    </svg>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <article class="testimonial__card text-center">
                                <div class="testimonial__card--thumbnail">
                                    <img class="testimonial__card--thumbnail__img display-block"
                                        src="{{asset('user/img/other/testimonial2.webp')}}" alt="testimonial-img">
                                </div>
                                <div class="testimonial__content">
                                    <p class="testimonial__content--desc">Lorem ipsum dolor sit amet,elit, sed do eiusmod
                                        tempor incididunt ut labore et dolore aliqua. </p>
                        ...
                        <div class="swiper-slide">
                            <article class="testimonial__card text-center">
                                <div class="testimonial__card--thumbnail">
                                    <img class="testimonial__card--thumbnail__img display-block"
                                        src="{{asset('user/img/other/testimonial3.webp')}}" alt="testimonial-img">
                                </div>
                                <div class="testimonial__content">
                                    <p class="testimonial__content--desc">Lorem ipsum dolor sit amet,elit, sed do eiusmod
                                        tempor incididunt ut labore et dolore aliqua. </p>
