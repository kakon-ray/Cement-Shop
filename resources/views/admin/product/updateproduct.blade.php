                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <select class="form-control" id="category_update" name="category"
                                                ...
                                                <option value="cement"
                                                    {{ $updateproduct->category == 'cement' ? 'selected' : '' }}>Cement
                                                </option>
                                                <option value="rod"
                                                    {{ $updateproduct->category == 'rod' ? 'selected' : '' }}>Road</option>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <select class="form-control" name="cement_brand"
                                                ...
                                                <option value="Elephant"
                                                    {{ $updateproduct->cement_brand == 'Elephant' ? 'selected' : '' }}>
                                                    Elephant</option>
                                                <option value="Basundhara"
                                                    {{ $updateproduct->cement_brand == 'Basundhara' ? 'selected' : '' }}>
                                                    Basundhara</option>
                                                <option value="Anwar"
                                                    {{ $updateproduct->cement_brand == 'Anwar' ? 'selected' : '' }}>Anwar
                                                </option>
                                                <option value="Scan"
                                    ...
                                    <div id="rod_update" class="row my-4">
                                        <div class="col-lg-6">
                                            ...
                                            <select class="form-control" name="rod_brand"
                                                aria-label="Default select example">
                                                <option value="AKS"
                                                    {{ $updateproduct->rod_brand == 'AKS' ? 'selected' : '' }}>AKS</option>
                                                <option value="SCRM"
                                                    {{ $updateproduct->rod_brand == 'SCRM' ? 'selected' : '' }}>SCRM
                                                </option>
                                                <option value="BSRM"
                                                    {{ $updateproduct->rod_brand == 'BSRM' ? 'selected' : '' }}>BSRM
                                                </option>
                                                <option value="NORMAL"
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <select class="form-control" name="rod_size"
                                                aria-label="Default select example">
                                                <option value="8m"
                                                    {{ $updateproduct->rod_size == '8m' ? 'selected' : '' }}>8m</option>
                                                <option value="10m"
                                                    {{ $updateproduct->rod_size == '10m' ? 'selected' : '' }}>10m</option>
                                                <option value="12m"
                                                    {{ $updateproduct->rod_size == '12m' ? 'selected' : '' }}>12m</option>
                                                <option value="16m"
                                                    {{ $updateproduct->rod_size == '16m' ? 'selected' : '' }}>16m</option>
                                                <option value="20m"
                                                    {{ $updateproduct->rod_size == '20m' ? 'selected' : '' }}>20m</option>
                                                <option value="22m"
                                                    {{ $updateproduct->rod_size == '22m' ? 'selected' : '' }}>22m</option>
                                                <option value="25m"
